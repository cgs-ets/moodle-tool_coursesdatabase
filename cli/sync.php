...
/**
 * CLI sync for course database synchronisation.
 *
...
if ($options['help']) {
    $help = "Execute course sync with external database.
...
Example:
\$ sudo -u www-data /usr/bin/php admin/tool/coursesdatabase/cli/sync.php
";
...
$result = $result | $coursesdatabase->sync($trace);
